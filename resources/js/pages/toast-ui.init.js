...
var barChart = tuiChart.barChart(container, data, options);
...
var columnChart = tuiChart.columnChart(container, data, options);
...
var lineChart = tuiChart.lineChart(container, data, options);
...
var areaChart = tuiChart.areaChart(container, data, options);
...
var radialChart = tuiChart.radialChart(container, data, options);
...
var bubbleChart = tuiChart.bubbleChart(container, data, options);
...
var scatterChart = tuiChart.scatterChart(container, data, options);
...
var pieChart = tuiChart.pieChart(container, data, options);
...
var donutChart = tuiChart.pieChart(container, data, options);
...
var heatmapChart = tuiChart.heatmapChart(container, data, options);

window.addEventListener('resize', function () {
    var heatmapChartChartWidth = document.getElementById("heatmap-charts").offsetWidth;
    heatmapChart.resize({
...
var treemapChart = tuiChart.treemapChart(container, data, options);

window.addEventListener('resize', function () {
    var treemapChartChartWidth = document.getElementById("treemap-charts").offsetWidth;
    treemapChart.resize({
...
var mapChart = tuiChart.mapChart(container, data, options);

window.addEventListener('resize', function () {
    var mapChartChartWidth = document.getElementById("map-charts").offsetWidth;
    mapChart.resize({
...
var boxplotChart = tuiChart.boxplotChart(container, data, options);

window.addEventListener('resize', function () {
    var boxplotChartChartWidth = document.getElementById("boxplot-charts").offsetWidth;
    boxplotChart.resize({
...
var bulletChart = tuiChart.bulletChart(container, data, options);

window.addEventListener('resize', function () {
    var bulletChartWidth = document.getElementById("bullet-charts").offsetWidth;
    bulletChart.resize({

...
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box d-md-flex justify-content-md-between align-items-center">
            <h4 class="page-title">Clipboard</h4>
            <div class="">
...
<div class="row justify-content-center">
        ...
        <div class="card">
            ...
            <div class="card-body pt-0">
                <div class="input-group">
                    <input type="text" class="form-control" id="clipboardInput" value="Welcome to Approx!" aria-label="Recipient's username" aria-describedby="button-addon2">
    ...
    <div class="col-md-6 col-lg-6">
        <div class="card">
            ...
            <div class="card-body pt-0">
                <textarea class="form-control" rows="3" id="clipboardTextarea">Welcome to Approx !</textarea>
                <div class="mt-3">

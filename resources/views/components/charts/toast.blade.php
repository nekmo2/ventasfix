@extends('layouts.vertical', ['title' => 'ToastUI'])

@section('css')
@vite(['node_modules/tui-chart/dist/tui-chart.min.css'])
@endsection
...
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box d-md-flex justify-content-md-between align-items-center">
            <h4 class="page-title">ToastUI</h4>
            <div class="">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active">ToastUI</li>
                </ol>
            </div>
...
@vite(['resources/js/pages/toast-ui.init.js'])
@endsection
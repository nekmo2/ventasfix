@extends('layouts.vertical', ['title' => 'Email-Billing'])
        ...
        <div class="page-title-box d-md-flex justify-content-md-between align-items-center">
            ...
            <div class="">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item"><a href="#">Email Tem.</a>
                    </li><!--end nav-item-->
                            ...
                            <tr>
                                <td class="content-wrap aligncenter" style="padding: 20px; background-color: transparent;" align="center" valign="top">
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td>
                                                <a href="#"><img src="/images/logo-sm.png" alt="" style="height: 50px; margin-left: auto; margin-right: auto; margin-bottom: 8px; display:block;"></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="content-block" style="padding: 0 0 20px;" valign="top">
                                                <h2 class="aligncenter" style="font-family: 'Helvetica Neue',Helvetica,Arial,'Lucida Grande',sans-serif;font-size: 24px; color:#98a2bd; line-height: 1.2em; font-weight: 600; text-align: center;" align="center">Thanks for using <span style="color: #22c55e; font-weight: 700;">Approx</span>.</h2>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td class="content-block aligncenter" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size: 14px; vertical-align: top; text-align: center; margin: 0; padding: 0 0 20px;" align="center" valign="top">
                                                Approx Inc. 123 my street, And my Country
                                            </td>
                                        </tr>
                                    </table><!--end table-->
                                </td>

@extends('layouts.vertical', ['title' => 'Fontawesome'])
...
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box d-md-flex justify-content-md-between align-items-center">
            <h4 class="page-title">Fontawesome</h4>
            <div class="">
            ...
            <div class="card-body pt-0">
                <section>
                    <div class="icon-demo-content row">
                        ...
                        <div class="col-sm-6 col-md-4 col-xl-3">
                            <i class="fas fa-sort-aApprox-down"></i> fas fa-sort-aApprox-down
                        </div>
                        <div class="col-sm-6 col-md-4 col-xl-3">
                            <i class="fas fa-sort-aApprox-up"></i> fas fa-sort-aApprox-up
                        </div>
                        <div class="col-sm-6 col-md-4 col-xl-3">

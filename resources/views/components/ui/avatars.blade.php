            ...
            <div class="card-body pt-0">
                <div class="d-flex align-items-center">
                    <a class="me-2 d-inline-block" href="#">
                        <img src="/images/users/avatar-9.jpg" alt="user" class="thumb-xxl rounded-circle">
                    </a>
                    <a class="me-2 d-inline-block" href="#">
                        <img src="/images/users/avatar-9.jpg" alt="user" class="thumb-xl rounded-circle">
                    </a>
                    <a class="me-2 d-inline-block" href="#">
                        <img src="/images/users/avatar-9.jpg" alt="user" class="thumb-lg rounded-circle">
                    </a>
                    <a class="me-2 d-inline-block" href="#">
                        <img src="/images/users/avatar-9.jpg" alt="user" class="thumb-md rounded-circle">
                    </a>
                    <a class="me-2 d-inline-block" href="#">
                        <img src="/images/users/avatar-9.jpg" alt="user" class="thumb-sm rounded-circle">
                    </a>
                    <a class="me-2 d-inline-block" href="#">
                        <img src="/images/users/avatar-9.jpg" alt="user" class="thumb-xs rounded-circle">
                    </a>
                </div>
            </div><!--end card-body-->
        </div><!--end card-->
    ...
    <div class="col-md-6 col-lg-6">
        <div class="card">
            ...
            <div class="card-body pt-0">
                <div class="d-flex align-items-center">
                    <a class="me-2 d-inline-block" href="#">
                        <img src="/images/users/avatar-9.jpg" alt="user" class="thumb-xxl rounded">
                    </a>
                    <a class="me-2 d-inline-block" href="#">
                        <img src="/images/users/avatar-9.jpg" alt="user" class="thumb-xl rounded">
                    </a>
                    <a class="me-2 d-inline-block" href="#">
                        <img src="/images/users/avatar-9.jpg" alt="user" class="thumb-lg rounded">
                    </a>
                    <a class="me-2 d-inline-block" href="#">
                        <img src="/images/users/avatar-9.jpg" alt="user" class="thumb-md rounded">
                    </a>
                    <a class="me-2 d-inline-block" href="#">
                        <img src="/images/users/avatar-9.jpg" alt="user" class="thumb-sm rounded">
                    </a>
                    <a class="me-2 d-inline-block" href="#">
                        <img src="/images/users/avatar-9.jpg" alt="user" class="thumb-xs rounded">
                    </a>
                </div>
            </div><!--end card-body-->
        </div><!--end card-->

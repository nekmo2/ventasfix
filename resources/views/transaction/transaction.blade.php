@extends('layouts.vertical', ['title' => 'Transactions'])
                ...
                <div class="card-body">
                    <div class="row d-flex justify-content-center">
                        ...
                        <div class="col-12 col-lg-8">
                                            ...
                                            <div class="row d-flex justify-content-center">
                                                ...
                                                <div class="col-3 align-self-center">
                                                    <div
                                                        ...
                                                        <i class="iconoir-dollar-circle fs-22 align-self-center mb-0 text-muted opacity-50"></i>
                                                    </div>
                                                </div>
                                                <!--end col-->
                                            </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row d-flex justify-content-center">
                                                ...
                                                <div class="col-3 align-self-center">
                                                    <div
                                                        class="d-flex justify-content-center align-items-center thumb-md rounded mx-auto">
                                                        <i class="iconoir-calendar fs-22 align-self-center mb-0 text-muted opacity-50"></i>
                                                    </div>
                                                </div>
                                                <!--end col-->
                                            </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row d-flex justify-content-center">
                                                ...
                                                <div class="col-3 align-self-center">
                                                    <div
                                                        class="d-flex justify-content-center align-items-center thumb-md  rounded mx-auto">
                                                        <i class="iconoir-stats-report fs-22 align-self-center mb-0 text-muted opacity-50"></i>
                                                    </div>
                                                </div>
                                                <!--end col-->
                                            </div>
                            ...
                            <p class="mb-0  text-success bg-soft-success rounded p-2">The last transaction <span
                                    class="fw-bold text-dark">$2560.00</span> is Successful!</p>
                        </div><!--end col-->
                    </div><!--end row-->
                </div><!--end card-body-->
            </div><!--end card-->
                    ...
                    <div class="table-responsive">
                        <table class="table mb-0">
                            ...
                            <tr>
                                ...
                                <td>UI/UX Project</td>
                                <td>$700</td>
                                <td><span class="badge bg-danger-subtle text-danger fs-11 fw-medium px-2">Debit</span>
                                </td>
                                <td>
                                    <a href="#"><i class="las la-print text-secondary fs-18"></i></a>
                                    <a href="#"><i class="las la-download text-secondary fs-18"></i></a>
...
@section('script')
    ...
    @vite(['resources/js/pages/transactions.init.js','resources/js/DynamicSelect.js'])
@endsection
